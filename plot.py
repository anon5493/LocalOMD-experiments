...
if __name__ == '__main__':
    ...
    # #Plot current and avg
    # fig, axs  = plt.subplots(nrows=2, ncols=len(exp_generator.game_names))
    ...
    #     plot_ax(axs[1,i], df, 'average', y_label)
    #     axs[1,i].set_title(f'Average exp. in {game_name}'.replace('_',' ').replace('kuhn','Kuhn').replace('leduc','Leduc'))
